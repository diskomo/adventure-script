...
config.auto_update_config = {
    ...
    dependencies = {"lib/AdventureScript/config.lua", "lib/AdventureScript/controls.lua",
                    ...
                    "lib/AdventureScript/state.lua", "lib/AdventureScript/tour.lua", "lib/AdventureScript/ui.lua",
                    "lib/AdventureScript/vehicles.lua", "lib/AdventureScript/assets/banner.jpg",
                    "lib/AdventureScript/assets/controls-bus.png", "lib/AdventureScript/assets/controls-foot.png",
                    "lib/AdventureScript/assets/logo.png"}
}
